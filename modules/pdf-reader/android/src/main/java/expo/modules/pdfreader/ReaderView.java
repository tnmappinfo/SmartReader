...
public class ReaderView
	...
	private float selectStartX, selectStartY, selectEndX, selectEndY;
	...
	private void vibrateOnSelection(Context context) {
	...
	private void enterSelectionMode(MotionEvent e) {
	...
	private void showSelection() {
		...
		pageView.selectText(selectStartX, selectStartY, selectEndX, selectEndY, mCurrent);
	}
...
//			if (pageView != null)
//				pageView.selectText(e1.getX(), e1.getY(), e2.getX(), e2.getY(), mCurrent);
//		}
	...
	protected void onChildSetup(int i, View v) {
		...
		((PageView) v).setSelectionBox(null);
